...
def train(args):
    ...
    optimizer = optim.Adam(model.student.parameters(),
    ...
    for ep in range(args.start_epoch, args.epochs):
        ...
        for cnt, (batch_news_feature, history_index, candidate_index, targets) in enumerate(dataloader):
            if cnt > args.max_steps_per_epoch:
                break
            total_loss, distill_loss, hidden_loss, attn_loss, target_loss, y_student = model(
            ...
            if args.tensorboard:
                ...
                writer.add_scalar("attn_loss", attn_loss, g_step)
...
def test(args):
    ...
    with torch.no_grad():
        for input_ids in tqdm(news_dataloader):
            ...
            news_vec, _, _ = model.student.news_encoder(input_ids)
