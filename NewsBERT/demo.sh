...
teacher_trainable_layer="10 11"
student_trainable_layer="2 3"
model='NAML'
model_type='tnlrv3'
...
then
 ...
 --epochs ${epochs} --teacher_lr ${teacher_lr} --student_lr ${student_lr} --num_words_title ${num_words_title} --word_embedding_dim ${word_embedding_dim} \
 --teacher_ckpt ${teacher_ckpt} --lr ${lr}  \
 ...
 --num_teacher_layers ${num_teacher_layers} --num_student_layers ${num_student_layers} --teacher_trainable_layer ${teacher_trainable_layer} \
 --student_trainable_layer ${student_trainable_layer} --model ${model} --model_type ${model_type} \
...
then
 ...
 --train_data_dir ${train_data_dir} --test_data_dir ${test_data_dir} --temperature ${temperature} --coef ${coef} \
