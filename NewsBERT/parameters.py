...
def parse_args():
    ...
    parser.add_argument("--teacher_lr", type=float, default=0.0001)
    parser.add_argument("--student_lr", type=float, default=0.0001)
    ...
    parser.add_argument(
        "--teacher_trainable_layer",
        type=int, nargs='+',
        default=[],
        choices=list(range(12)))
    parser.add_argument(
        "--student_trainable_layer",
        type=int, nargs='+',
        default=[],
        choices=list(range(12)))
